...
export default function VerificationSentPage() {
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-white flex items-center justify-center">
      {/* Background Decorative Ovals - Same as login/signup */}
      <div 
      ...
      >
        ...
        {/* Right Side - Verification Message Card */}
        <div className="w-full max-w-[650px] bg-white border-2 border-black/5 shadow-[0px_0px_19px_rgba(0,0,0,0.25)] rounded-2xl p-6 md:p-10 lg:p-[41px_40px] flex flex-col items-center gap-[56px]">
          {/* Message Content */}
          <div className="flex flex-col items-center gap-4 w-full max-w-[570px]">
            {/* Success Heading */}
            <h1 className="font-['SF_Pro'] font-[590] text-[32px] md:text-[42px] leading-[50px] text-[#34A853] text-center">
              Verification Sent!
            </h1>
            
            {/* Description Text */}
            <p className="font-['Inter'] font-medium text-[16px] md:text-[18px] leading-[160%] tracking-[-0.04em] text-[#616161] text-center w-full">
              You&apos;re just one click away! A verification email is waiting in your inbox. Check your mail now to activate your account and start using Ghostwriter AI.
            </p>
          </div>

          {/* Security Notice */}
          <div className="flex items-center gap-2 w-full max-w-[382px] justify-center">
